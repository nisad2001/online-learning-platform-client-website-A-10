  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6 mt-10 mb-10">
      ...
      <div className="flex justify-between">
       ...
       <button className="btn bg-green-600 rounded-2xl">Enroll now</button>
      </div>
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        <Link to={`/update-courses/${course._id}`} className="btn btn-primary rounded-2xl w-4/12 transition transform hover:scale-105 hover:shadow-lg">
        Update
        </Link>
        <button onClick={handleDelete} className="btn btn-secondary rounded-2xl w-4/12 transition transform hover:scale-105 hover:shadow-lg">
            Delete
        </button>
